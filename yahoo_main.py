...
from new_model import MF_BV_Multi_bin_JL_G_DR
...
def exp(args):
    ...
    mf_ips = MF_BV_Multi_bin_JL_G_DR(num_user, num_item, batch_size=args.training_args['batch_size'], monte_sample_num=args.monte_sample_num, embedding_k=args.base_model_args['emb_dim'], batch_size_prop=args.training_args['batch_size_prop'])
    mf_ips = mf_ips.cuda()
...
if __name__ == "__main__": 
    ...
    def objective(trial):
        ...
        # monte_sample_num=trial.suggest_int('monte_sample_num',10,60) #g.1 120
        # learning_rate_prop = trial.suggest_categorical('learning_rate_prop',[0.01,0.02, 0.05])
        ...
        args.training_args['batch_size_prop']=204800
